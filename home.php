...
<head>
    ...
    <title>Testimony Poly homepage</title>
        ...
        <div class="layout">
            ...
            <div class="header">
                <div class="logo logo-dark">
                    <a href="index.php">
                        <div class="p-3">
                            <h1 style="color: black; font-weight: 900; font-size: 25px;">Testimony Poly</h1>
                        </div>
                    </a>
                </div>
                                                    ...
                                                    <div class="checkbox">
                                                        ...
                                                        <label for="task-today-1" class="d-flex align-items-center">
                                                            <span class="inline-block m-l-10">
                                                                <span
                                                                    class="text-dark font-weight-semi-bold font-size-16">Define
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <div class="checkbox">
                                                        ...
                                                        <label for="task-today-2" class="d-flex align-items-center">
                                                            <span class="inline-block m-l-10">
                                                                <span
                                                                    class="text-dark font-weight-semi-bold font-size-16">Schedule
                                                                    jobs</span>
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <div class="checkbox">
                                                        ...
                                                        <label for="task-today-3" class="d-flex align-items-center">
                                                            <span class="inline-block m-l-10">
                                                                <span
                                                                    class="text-dark font-weight-semi-bold font-size-16">Extend
                                                                    the data model</span>
                                                                <span class="m-b-0 text-muted font-size-13 d-block">Let
                                                                    us wax poetic about cheeseburger</span>
                                                            </span>
                                                        </label>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <div class="checkbox">
                                                        ...
                                                        <label for="task-today-4" class="d-flex align-items-center">
                                                            <span class="inline-block m-l-10">
                                                                <span
                                                                    class="text-dark font-weight-semi-bold font-size-16">Change
                                                                    interface</span>
                                                                <span
                                                                    class="m-b-0 text-muted font-size-13 d-block">Efficiently
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <div class="checkbox">
                                                        ...
                                                        <label for="task-today-5" class="d-flex align-items-center">
                                                            <span class="inline-block m-l-10">
                                                                <span
                                                                    class="text-dark font-weight-semi-bold font-size-16">Create
                                                                    databases</span>
                                                                <span
                                                                    class="m-b-0 text-muted font-size-13 d-block">Here's
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <div class="checkbox">
                                                        ...
                                                        <label for="task-week-1" class="d-flex align-items-center">
                                                            <span class="inline-block m-l-10">
                                                                <span
                                                                    class="text-dark font-weight-semi-bold font-size-16">Verify
                                                                    connectivity</span>
                                                                <span
                                                                    class="m-b-0 text-muted font-size-13 d-block">Bugger
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <div class="checkbox">
                                                        ...
                                                        <label for="task-week-2" class="d-flex align-items-center">
                                                            <span class="inline-block m-l-10">
                                                                <span
                                                                    class="text-dark font-weight-semi-bold font-size-16">Order
                                                                    console machines</span>
                                                                <span
                                                                    class="m-b-0 text-muted font-size-13 d-block">Value
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <div class="checkbox">
                                                        ...
                                                        <label for="task-week-3" class="d-flex align-items-center">
                                                            <span class="inline-block m-l-10">
                                                                <span
                                                                    class="text-dark font-weight-semi-bold font-size-16">Customize
                                                                    Template</span>
                                                                <span class="m-b-0 text-muted font-size-13 d-block">Do
                                                                    you see any Teletubbies in here</span>
                                                            </span>
                                                        </label>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <div class="checkbox">
                                                        ...
                                                        <label for="task-week-4" class="d-flex align-items-center">
                                                            <span class="inline-block m-l-10">
                                                                <span
                                                                    class="text-dark font-weight-semi-bold font-size-16">Batch
                                                                    schedule</span>
                                                                <span
                                                                    class="m-b-0 text-muted font-size-13 d-block">Trillion
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <div class="checkbox">
                                                        ...
                                                        <label for="task-week-5" class="d-flex align-items-center">
                                                            <span class="inline-block m-l-10">
                                                                <span
                                                                    class="text-dark font-weight-semi-bold font-size-16">Prepare
                                                                    implementation</span>
                                                                <span class="m-b-0 text-muted font-size-13 d-block">Drop
                                                                    in axle roll-in rail slide</span>
                                                            </span>
                                                        </label>
                                                    </div>
                                                </div>
                                                        ...
                                                        <label for="task-month-1" class="d-flex align-items-center">
                                                            <span class="inline-block m-l-10">
                                                                <span
                                                                    ...
                                                                    user groups</span>
                                                                <span
                                                                    class="m-b-0 text-muted font-size-13 d-block">Nipperkin
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <div class="checkbox">
                                                        ...
                                                        <label for="task-month-2" class="d-flex align-items-center">
                                                            <span class="inline-block m-l-10">
                                                                <span
                                                                    class="text-dark font-weight-semi-bold font-size-16">Design
                                                                    Wireframe</span>
                                                                <span
                                                                    class="m-b-0 text-muted font-size-13 d-block">Value
                                                                    proposition alpha crowdsource</span>
                                                        ...
                                                        <label for="task-month-3" class="d-flex align-items-center">
                                                            <span class="inline-block m-l-10">
                                                                <span
                                                                    class="text-dark font-weight-semi-bold font-size-16">Customize
                                                                    Template</span>
                                                                <span class="m-b-0 text-muted font-size-13 d-block">I'll
                                                                    be sure to note that</span>
                                                            </span>
                                                        </label>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <div class="checkbox">
                                                        ...
                                                        <label for="task-month-4" class="d-flex align-items-center">
                                                            <span class="inline-block m-l-10">
                                                                <span
                                                                    class="text-dark font-weight-semi-bold font-size-16">Management
                                                                    meeting</span>
                                                                <span
                                                                    class="m-b-0 text-muted font-size-13 d-block">Hand-crafted
                                                        ...
                                                        <label for="task-month-5" class="d-flex align-items-center">
                                                            <span class="inline-block m-l-10">
                                                                <span
                                                                    ...
                                                                    data model</span>
                                                                <span
                                                                    class="m-b-0 text-muted font-size-13 d-block">European
